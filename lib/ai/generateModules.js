...
You may be given source material from SEVERAL categories (NCERT, government/official, newspaper, other) -- draw on EVERY category you're actually given, not just whichever one is richest; a student relying on this as their sole source needs the NCERT foundation AND the government/official detail AND anything else provided, not just one. Cover every genuinely distinct aspect of this module's scope: what the concept is, its constitutional/legal/factual basis, how it works or developed, why it matters, and how it plays out across different real question framings.
